...
describe('favoriteBlog', () => {
  ...
  test('expect result is the blog which has the most likes',() => {
...
describe('mostBlogs', () => {
  ...
  test('expect return the author who has the largest amount of blogs',() => {
...
describe('mostLikes', () => {
  ...
  test('expect return the author who has the most likes',() => {
